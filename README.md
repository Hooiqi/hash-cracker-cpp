...
Forked and extended from the hash-cracker project in CarterPerez-dev/Cybersecurity-Projects, licensed under AGPL 3.0. This repo builds on the original implementation with my own additions (see Changes From Original).
